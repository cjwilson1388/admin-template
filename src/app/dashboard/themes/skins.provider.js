(function() {
    ...
    angular
        ...
        .provider('dashboardSkins', skinsProvider)
        .run(addSkinToScope);

    /* @ngInject */
    function skinsProvider($mdThemingProvider, dashboardThemingProvider) {
        var skins = {};
        ...
        return {
            skin: function(id, name) {
                ...
                var skin = new Skin(id, name, $mdThemingProvider, dashboardThemingProvider);
            ...
            setSkin: function(id) {
                ...
                if(useSkinCookie) {
                    ...
                    var dashboardSkin = $cookies.get('dashboard-skin');
                    if(angular.isDefined(dashboardSkin)) {
                        var cookieTheme = angular.fromJson(dashboardSkin);
    ...
    /* @ngInject */
    function Skin(id, name, $mdThemingProvider, dashboardThemingProvider) {
        ...
        self.loadThemes = function() {
            ...
            for (var element in self.elements) {
                ...
                var theme = dashboardThemingProvider.theme(self.elements[element]);
    ...
    /* @ngInject */
    function addSkinToScope($rootScope, dashboardSkins) {
        $rootScope.dashboardSkin = dashboardSkins.getCurrent();
    }
})();
