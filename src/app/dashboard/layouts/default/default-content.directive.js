(function() {
    ...
    angular
        ...
        .directive('dashboardDefaultContent', dashboardDefaultContent);

    /* @ngInject */
    function dashboardDefaultContent ($rootScope, $compile, $templateRequest) {
        // Usage:
        //
        // Creates:
        //
        ...
        function link($scope, $element) {
            ...
            function injectFooterUpdateContent() {
                ...
                if (footerElem.length === 0) {
                    ...
                    $templateRequest('app/dashboard/components/footer/footer.tmpl.html')
