(function() {
    ...
    angular
        .module('dashboard')
        .run(layoutRunner)
        .provider('dashboardLayout', layoutProvider);
    ...
    /* @ngInject */
    function layoutRunner($rootScope, dashboardLayout) {
        ...
        var destroyOn = $rootScope.$on('$stateChangeStart', dashboardLayout.updateLayoutFromState);
